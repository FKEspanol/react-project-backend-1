...
const registerUser = async (req, res) => {
   ...
   try {
      ...
      const base64 = req.body.picture.replace("data:image/jpeg;base64,", ""); //*convert base64 encoding to image and place it in specifig folder in this case in userProfiles folder
      ...
      fs.writeFile(output_filePath, base64, "base64", err => console.log(err));
